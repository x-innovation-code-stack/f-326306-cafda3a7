        ...
        <Motion animation="fade-up" delay={0.1} duration={0.8}>
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-muted-foreground mt-2">
              Elegant simplicity for the modern digital experience.
            </p>
          </div>
        </Motion>

        <Motion animation="fade-up" delay={0.2} duration={0.8}>
...
const ScrollToTopButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-8 right-8 w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center shadow-lg transition-all duration-300 ${
